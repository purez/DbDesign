...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
       ...
       <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd class="layui-this"><a href="towhere?tourl=buyAdmin"><i class="layui-icon layui-icon-group" style="font-size: 14px; color: #xe66f;"></i>供应商管理</a></dd>
  ...
  <div class="layui-body">
    ...
    <div><button onclick="add()" class="layui-btn layui-btn-normal ">伙伴添加</button></div>
   <div  id="add" style="display:none">
<form class="layui-form" action="addSupplier" mehod="post">
 	<div class="layui-form-item">
	    ...
	    <label class="layui-form-label" >供应商ID:</label>
		    ...
		    <div class="layui-input-block">
		      <input type="text" id="sid" autocomplete="off" class="layui-input"  disabled="false">
		      <input type="hidden" id="sid1" name="sid" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
     ...
     <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="dealer" required  lay-verify="required"  autocomplete="off" class="layui-input">
	    </div>
   </div>
...
layui.use(['jquery', 'layer'], function(){ 
	  ...
	  var Num=""; 
	   ...
	   $("#sid")[0].value=item+Num.toString();  
	   $("#sid1")[0].value=item+Num.toString(); 
	   $("#sid")[0].disabled=true;   
});;
$(document).ready( function () {
    $('#table_id_example').DataTable( {
        ...
        "ajax": "${pageContext.request.contextPath}/listSupplier",
        "columns": [
            { "data": "sid" },
            { "data": "sname" },
            { "data": "dealer" },
        ...
        "columnDefs": [ {
            ...
            render: function (data, type, row, meta) {
                return '<a type="button" class="layui-btn layui-btn-xs" id="edit" href="#" onclick="edit('+row.sid+')" >查看/编辑</a>'
                +'<a type="button" class="layui-btn layui-btn-danger layui-btn-xs"  href="#"  onclick="del('+row.sid+')">删除</a>'
                ;
            }
          } ]
...
function del(index){  
	 ...
	 $.ajax({
        url: "${pageContext.request.contextPath}/deleteSupplier",
        type: "POST",
        data:{sid:index},
        dataType: "text",
  ...
  function edit(index) {  
	  ...
	  layer.open({  
	        ...
	        maxmin: false,  
	        closeBtn: 1,  
	        content: 'showSupplier?sid='+index+''
	    });  
